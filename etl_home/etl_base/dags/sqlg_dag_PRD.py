...
D_STG_INITxSYS_STS_STGxD_SDM_PRD.set_downstream(sqlg_jobs_PRD.SDM_RD_LABOR_HOURS_EXPENSE)
...
D_ODS_PRDxPCS_LINEERxD_SDM_PRD.set_downstream(sqlg_jobs_PRD.SDM_EPR_MFG_CONVERSION_COST)
...
sqlg_jobs_PRD.SDM_DMST_AND_INTL_TRAVEL_EXP.set_downstream(sqlg_jobs_PRD.SDM_PRODUCT_ACTUAL_EXPENSE)
sqlg_jobs_PRD.SDM_EPR_MFG_CONVERSION_COST.set_downstream(sqlg_jobs_PRD.SDM_PRODUCT_ACTUAL_EXPENSE)
sqlg_jobs_PRD.SDM_EPR_MFG_SAMPLE_BUILD_EXP.set_downstream(sqlg_jobs_PRD.SDM_PRODUCT_ACTUAL_EXPENSE)
sqlg_jobs_PRD.SDM_CTF_EXPENSE.set_downstream(sqlg_jobs_PRD.SDM_PRODUCT_ACTUAL_EXPENSE)
sqlg_jobs_PRD.SDM_EQT_EXPENSE.set_downstream(sqlg_jobs_PRD.SDM_PRODUCT_ACTUAL_EXPENSE)
sqlg_jobs_PRD.SDM_TOOLING_TOTAL_EXPENSE.set_downstream(sqlg_jobs_PRD.SDM_PRODUCT_ACTUAL_EXPENSE)
...
D_SDM_PRDxSDM_EPR_MFG_CONVERSION_COSTxD_DM_PRD.set_downstream(sqlg_jobs_PRD.FCT_EPR_MFG_CONVERSION_COST)
...
D_SDM_PRDxSDM_DMST_AND_INTL_TRAVEL_EXPxD_DM_PRD.set_downstream(sqlg_jobs_PRD.FCT_DMST_AND_INTL_TRAVEL_EXP)
