...
COMMENT ON TABLE SDM.SDM_UPLOAD_CDOC_COUNT IS 'C 文號完成數量_';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT.PROJECT_CODE IS '專案代碼';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT.BUSINESS_GROUP IS '標準-事業群';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT.MODEL IS 'Model';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT.MANUFACTURING_PLANT IS '標準-製造廠';
...
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT.UPLOAD_CDOC_COUNT IS 'C 文號完成數量_';
...
--Comments Create Script 
COMMENT ON TABLE SDM.SDM_UPLOAD_CDOC_COUNT_TP1 IS 'C 文號完成數量_暫存檔';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT_TP1.PROJECT_CODE IS '專案代碼';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT_TP1.BUSINESS_GROUP IS '標準-事業群';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT_TP1.MODEL IS 'Model';
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT_TP1.MANUFACTURING_PLANT IS '標準-製造廠';
...
COMMENT ON COLUMN SDM.SDM_UPLOAD_CDOC_COUNT_TP1.UPLOAD_CDOC_COUNT IS 'C 文號完成數量_';
